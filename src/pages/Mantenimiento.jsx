  ...
  return (
    <div className="wrapper">
      ...
      <section className="page-title page-title-layout2 bg-overlay bg-overlay-2 bg-parallax">
        <div className="bg-img"><img src="/assets/images/page-titles/incendio.jpg" alt="Mantenimiento Preventivo y Correctivo" /></div>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h1 className="pagetitle__heading mb-0">Mantenimiento Preventivo y Correctivo</h1>
              <p className="pagetitle__desc">
                Programas de mantenimiento a la medida, inspecciones periódicas con pruebas y reparaciones, y atención de
                emergencias para asegurar la continuidad operativa de tus sistemas contra incendios.
              </p>
            ...
            <div className="col-lg-12">
              ...
              <div className="text__block mb-30">
                ...
                <p className="text__block-desc">
                  En <strong>AFC Pro Fire</strong> mantenemos tus sistemas contra incendios en estado óptimo.
                  Nuestros planes combinan rutinas preventivas, inspecciones y pruebas bajo NFPA 25, NFPA 72 y soporte correctivo, con reportes y trazabilidad para auditorías.
                </p>
              </div>
              ...
              <div className="row mb-40">
                <div className="col-sm-12">
                  <div className="gallery-item">
                    <img src="/assets/images/services/mantenimiento.png" alt="galería" />
                  </div>
                </div>
              </div>
              ...
              <div className="text__block mb-30">
                <h5 className="text__block-title">Programas de Mantenimiento Adaptados</h5>
                <p className="text__block-desc">
                  Planes de mantenimiento preventivo y correctivo diseñados según el tipo de sistema, nivel de riesgo y operación del cliente, asegurando continuidad y confiabilidad.
                </p>
              </div>

              <div className="text__block mb-30">
                <h5 className="text__block-title">Inspecciones, Pruebas y Reparaciones</h5>
                <p className="text__block-desc">
                  Ejecución periódica de inspecciones técnicas, pruebas funcionales y reparaciones oportunas para garantizar el correcto funcionamiento de los sistemas contra incendio.
                </p>
              </div>

              <div className="text__block mb-0">
                <h5 className="text__block-title">Atención de Emergencias</h5>
                <p className="text__block-desc">
                  Respuesta técnica rápida ante fallas o eventos críticos, con personal especializado disponible para restablecer la operación y mitigar riesgos.
                </p>
              </div>
              ...
              <div className="row features-layout3 mt-40">
                <div className="col-sm-4">
                  <div className="feature-item">
                    ...
                    <h4 className="feature__title">Disponibilidad</h4>
                    <p className="feature__desc">Menos paros y mayor confiabilidad.</p>
                  </div>
                </div>
                <div className="col-sm-4">
                  <div className="feature-item">
                    ...
                    <p className="feature__desc">Rutinas conforme a NFPA 25.</p>
                  </div>
                </div>
              </div>
