  ...
  return (
    <div className="wrapper">
      ...
      <section className="page-title page-title-layout2 bg-overlay bg-overlay-2 bg-parallax">
        <div className="bg-img"><img src="/assets/images/page-titles/incendio.jpg" alt="Conceptualización y Diseño de Soluciones" /></div>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h1 className="pagetitle__heading mb-0">Conceptualización y Diseño de Soluciones</h1>
              <p className="pagetitle__desc">
                Desarrollo de propuestas técnicas y económicas, estudios de viabilidad y rentabilidad,
                y modelado y simulación de escenarios para tomar decisiones con datos y optimizar la inversión.
              </p>
      ...
      <section className="text-content-section pb-90">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-12">
              ...
              <div className="text__block mb-30">
                ...
                <p className="text__block-desc">
                  Transformamos necesidades en soluciones viables y rentables. Partimos de objetivos de negocio y
                  requisitos técnicos para diseñar alternativas comparables, estimar costos y beneficios a lo largo
                  del ciclo de vida y validar el desempeño mediante simulaciones y criterios normativos.
                </p>
              </div>
              ...
              <div className="row mb-40">
                <div className="col-sm-12">
                  <div className="gallery-item">
                    <img src="/assets/images/services/conceptualizacion.png" alt="galería" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text__block mb-30">
              <h5 className="text__block-title">Desarrollo de Propuestas Técnicas y Económicas</h5>
            </div>

            <div className="text__block mb-30">
              <h5 className="text__block-title">Estudios de Viabilidad y Rentabilidad</h5>
            </div>

            <div className="text__block mb-0">
              <h5 className="text__block-title">Modelado y Simulación de Escenarios</h5>
            </div>
            ...
            <div className="row features-layout3 mt-40">
              <div className="col-sm-4">
                <div className="feature-item">
                  ...
                  <h4 className="feature__title">Alineación</h4>
                  <p className="feature__desc">Soluciones enfocadas en objetivos y riesgo.</p>
                </div>
              </div>
              <div className="col-sm-4">
                <div className="feature-item">
                  <div className="feature__icon"><i className="icon-layers"></i></div>
                  <h4 className="feature__title">Rigurosidad</h4>
                  <p className="feature__desc">Comparativos claros y trazables.</p>
                </div>
              </div>
              <div className="col-sm-4">
                <div className="feature-item">
                  <div className="feature__icon"><i className="icon-piggy-bank"></i></div>
                  <h4 className="feature__title">Valor</h4>
                  <p className="feature__desc">Optimización de CAPEX y OPEX.</p>
                </div>
              </div>
            </div>
